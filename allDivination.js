...
// 総合運
const all = {
    1: ["大事な何かが404する", "スループットが出ない1日", " 人生の何かが404する予感"],
    2: ["ルール変更に振り回される", "スクラムで何とか乗り切ろう", "IE確認はお早めに"],
...
const health = {
    ...
    3: ["目のピクピクに注意", "目が疲れ気味!目を温めよう", "不眠症になる気配あり"],
    4: ["肩こりが解消方向に向かう"],
    5: ["デスマに耐えうる体が手にはいる"]
};
...
const work = {
    ...
    5: ["説明しただけなのに褒められる", "完璧な疎結合が実現", "天才と称賛の嵐, CTO就任!?"]
};

// 恋愛運
const love = {
    1: ["同棲相手に401 Unauthorizedされる", "出会いが404 not found"],
    ...
    4: ["気になる人とモニタ越しに目が合う", "金融システム並みに安定した恋愛に", "新しい職場で出会いあり", "久々に連絡する人とご縁あり"],
